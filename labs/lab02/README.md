...
5. Для leaf- и spine-узлов на интерфейсах пиринга настраиваем BFD с параметрами `100/100/3`.
6. Для leaf- и spine-узлов на интерфейсах пиринга настраиваем аутентификацию OSPF с MD5.
